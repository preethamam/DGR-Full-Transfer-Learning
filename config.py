...
demo_arg.add_argument('--pcd0', default="dgr_src_1.ply", type=str)
demo_arg.add_argument('--pcd1', default="dgr_tgt_1.ply", type=str)
demo_arg.add_argument('--savetxt', default="./output.txt", type=str)
# yapf: enable

# Multiway arguments
multiway_arg = add_argument_group('multiway')
multiway_arg.add_argument('-d','--pcd_folder', nargs='+', default="/media/preethamam/Utilities-SSD/Xtreme_Programming/Preetham/Project PCloud/test_data/bedroom", type=str)
multiway_arg.add_argument('--pair_registration_method', default="dgr", type=str) # 'icp' | 'dgr'
multiway_arg.add_argument('--firstNfiles', default=0, type=int)
multiway_arg.add_argument('--showPlots', default=0, type=int)
multiway_arg.add_argument('--multiway_voxel_size', type=float, default=0.02)
multiway_arg.add_argument('--verbose', type=int, default=0)
