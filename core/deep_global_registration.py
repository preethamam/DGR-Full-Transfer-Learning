...
def registration_ransac_based_on_feature_matching(pcd0, pcd1, feats0, feats1,
  ...
  result = o3d.pipelines.registration.registration_ransac_based_on_feature_matching(
      pcd0, pcd1, source_feat, target_feat, True, distance_threshold,
...
class DeepGlobalRegistration:
  ...
  def __init__(self, config, device = cudaDevice):
    # Basic config
    self.config = config
  ...
  def safeguard_registration(self, pcd0, pcd1, idx0, idx1, feats0, feats1,
    ...
    elif self.safeguard_method == 'feature_matching':
  ...
  def register(self, xyz0, xyz1, inlier_thr=0.00):
    ...
    if self.use_icp:
      registrationResult = o3d.pipelines.registration.registration_icp(
                            make_open3d_point_cloud(xyz0),
                            make_open3d_point_cloud(xyz1), self.voxel_size * 2, T,
                            o3d.pipelines.registration.TransformationEstimationPointToPoint())
      T, rmse = registrationResult.transformation, registrationResult.inlier_rmse
